...
public class DataPatternFormatter {
	...
	private static final String DATE_REGEX_2 = "^(([0-9])|([0-2][0-9])|([3][0-1]))\\-(jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec)\\-\\d{4}$";
	...
	public static int validateDate2(String date) {
		return validateData(date, DATE_REGEX_2);
	}
